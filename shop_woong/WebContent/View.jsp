...
<body>
	...
	<form action = "EditBoardProcess.jsp" method = "post">
		...
		<div class = "row g-2 align-items-center" id = "col">
			<div class = "col-auto">
				<label for="num" class="col-form-label">게시물 이름</label>
			</div>
			
			<div class = "col-auto">
				<input type = "text" id = "name" name = "name"
				class = "form-control" value = "<%=dto.getName()%>" >
			</div>
		</div>
		
		<div class = "row g-2 align-items-center" id = "col">
			<div class = "col-auto">
				<label for="num" class="col-form-label">게시물 제목</label>
			</div>
		...
		<div class = "row g-2 align-items-center" id = "col">
			<div class = "col-auto">
				<label for="num" class="col-form-label">게시물 내용</label>
			</div>
